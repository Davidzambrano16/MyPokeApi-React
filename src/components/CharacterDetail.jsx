...
const CharacterDetail = () => {
  ...
  return (
    ...
    <div className="characterDetail">
      <Header />
      <div className="containerButtonExit">
        <button className="buttonExit" onClick={backPage}>
            <i className="fa-solid fa-right-from-bracket fa-rotate-180" style={{"color": "#ebeaea"}}></i>
        </button>
      </div>
